...
class SynthesisBase(models.Model):
    PR = models.FloatField(help_text="Probability ratio", validators=[MinValueValidator(0.0)], null=True, blank=True)
    ...
    Delta_I = models.FloatField(help_text="Intensity change",  null=True, blank=True)
...
class Event(models.Model):
    ...
    attribution_consideration_statement = models.TextField(help_text="Reason why no attribution studies have been done", blank=True, null=True)
    def __str__(self):
        return self.name
